      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={24}>
          <Card title={<><UserOutlined className="me-2" />Información del Profesor</>} size="small">
            <Descriptions column={1} bordered size="small">
              <Descriptions.Item label="ID del Profesor">
                <UserOutlined className="me-1 text-primary" />
                <strong>{assignmentData.teacherId}</strong>
              </Descriptions.Item>
              {assignmentData.teacherName && (
        ...
        <Col span={12}>
          <Card title={<><BookOutlined className="me-2" />Curso Asignado</>} size="small">
            <Descriptions column={1} bordered size="small">
              <Descriptions.Item label="ID del Curso">
                <BookOutlined className="me-1 text-success" />
                <strong>{assignmentData.courseId}</strong>
              </Descriptions.Item>
        ...
        <Col span={12}>
          <Card title={<><HomeOutlined className="me-2" />Aula Asignada</>} size="small">
            <Descriptions column={1} bordered size="small">
              <Descriptions.Item label="ID del Aula">
                <HomeOutlined className="me-1 text-info" />
                <strong>{assignmentData.classroomId}</strong>
              </Descriptions.Item>
              {assignmentData.classroomName && (
