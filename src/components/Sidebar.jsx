          ...
          >
              <ul>
               ...
               {/* Settings - Solo Admin */}
                ...
                {/* Gestión de Cursos - Solo Secretary */}
                {isSecretary() && (
                  <li>
                    <Link 
                      className={props?.activeClassName === 'course-list' ? 'active' : ''} 
                ...
                {/* Gestión de Períodos - Solo Secretary */}
                {isSecretary() && (
                  <li>
                    <Link 
                      className={props?.activeClassName === 'period-list' ? 'active' : ''} 
                      to="/secretary/periods"
                    >
                      <span className="menu-side">
                ...
                {/* Gestión de Aulas - Solo Secretary */}
                {isSecretary() && (
                  <li>
                    <Link 
                      className={props?.activeClassName === 'classroom-list' ? 'active' : ''} 
                      to="/secretary/classrooms"
                    >
                      <span className="menu-side">
                ...
                {/* Asignaciones de Profesores - Solo Secretary */}
                {isSecretary() && (
                  <li>
                    <Link 
                      className={props?.activeClassName === 'teacher-assignment-list' ? 'active' : ''} 
                      to="/secretary/teacher-assignments"
                    >
                      <span className="menu-side">
                        <i className="fa fa-users"></i>
                      </span>{" "}
                      <span>Asignaciones de Profesores</span>
                    </Link>
                  </li>
                )}
